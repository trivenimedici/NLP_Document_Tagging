...
class Model_Training:
    ...
    def trainingModel(self):
        ...
        #     self.log.log(self.file_object, f'The column names for training data are {X.columns}')
            ...
            #     cluster_features=cluster_data.drop(['ArticleCategory','Cluster'],axis=1)
            #     cluster_label= cluster_data['ArticleCategory']
